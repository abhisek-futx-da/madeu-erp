...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'offline_queue', label: 'Offline Scan Queue' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ledger', label: 'Ledger (Any Account)' },
      { id: 'order_lines', label: 'Order Lines With Specification' },
      { id: 'cash_and_bank_book', label: 'Cash & Bank Book' },
      { id: 'contra', label: 'Contra (Cash / Bank Transfer)' },
      { id: 'trading', label: 'Trading Account' },
      { id: 'profit_loss', label: 'Profit & Loss' },
      { id: 'balance_sheet', label: 'Balance Sheet' },
      { id: 'trial_balance', label: 'Trial Balance' },
      { id: 'trial_balance_grouped', label: 'Trial Balance By Group' },
      { id: 'party_statement', label: 'Party Statement' },
      { id: 'receivable_ageing', label: 'Receivable Ageing' },
      { id: 'interest_receivable', label: 'Interest On Overdue (Vyaj)' },
      { id: 'document_emails', label: 'Email Outbox' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'stock_by_location', label: 'Stock By Godown' },
